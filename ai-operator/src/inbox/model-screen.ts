...
const SYSTEM_PROMPT = [
  ...
  "rekrutacja, newsletter, spam. UWAGA na kierunek transakcji: potwierdzenie,",
  "wysyłka albo obsługa zamówienia, które MY złożyliśmy u dostawcy (to my",
  "jesteśmy kupującym), to także „nie_klient” — klientem jest ten, kto kupuje",
  "OD NAS, nie ten, u kogo kupujemy MY. Etykieta ma nazywać, czym to jest",
