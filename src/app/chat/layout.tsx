...
export default function ChatLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex bg-white overflow-hidden">
      {/* Sidebar - nawigacja globalna */}
      <Sidebar user={user} onLogout={logout} />

      {/* Lista konwersacji */}
      <div className={`w-80 border-r border-slate-200 flex flex-col bg-white ${showMobileChat ? 'hidden md:flex' : 'flex'}`}>
        <ChannelList
          channels={channels}
        ...
        {pathname === '/chat' ? (
          ...
          <>
            ...
            <button
              ...
              className="md:hidden flex items-center gap-2 px-4 py-2 text-indigo-600 font-medium border-b border-slate-100"
            >
